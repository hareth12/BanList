namespace TwoFactorAuthentication.API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (provider == "Facebook")
                {
                    ...
                    if (
                        !string.Equals(Startup.FacebookAuthOptions.AppId, parsedToken.AppId,
                ...
                else if (provider == "Google")
                {
                    ...
                    if (
                        !string.Equals(Startup.GoogleAuthOptions.ClientId, parsedToken.AppId,
                            StringComparison.OrdinalIgnoreCase))
                    {
                        return null;
                    }
        ...
        private string ValidateClientAndRedirectUri(HttpRequestMessage request, ref string redirectUriOutput)
        {
            ...
            Client client = repo.FindClient(clientId);
